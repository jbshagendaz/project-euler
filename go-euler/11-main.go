...
func main() {
   var array = [20][20]int{{ 8,  2, 22, 97, 38, 15,  0, 40,  0, 75,  4,  5,  7, 78, 52, 12, 50, 77, 91,  8},
   ...
   for i:=0; i<20; i++ {
      for j:=0; j<20; j++ {
         if(i >= 3){
            tmp = array[i-3][j] * array[i-2][j] * array[i-1][j] * array[i][j]
         ...
         if(j >= 3){
            tmp = array[i][j-3] * array[i][j-2] * array[i][j-1] * array[i][j]
         ...
         if((i>=3) && (j>=3)){
            tmp = array[i-3][j-3] * array[i-2][j-2] * array[i-1][j-1] * array[i][j]
            if tmp > num {
               num = tmp
               n1 = array[i-3][j-3]
               n2 = array[i-2][j-2]
